	...
	Tree.prototype = {
		...
		_buildTree: function(nodes, level) {
			...
			$.each(nodes, function addNodes(id, node) {
				...
				// Add font to mimic tree structure
				for (var i = 0; i < (level - 1); i++) {
					treeItem.append(self._template.font);
				}
		...
		_template: {
			...
			/*badge: '<span class="badge"></span>'*/
			 font:'<span class="glyphicon glyphicon-ok font"></span>'
		},

		_css: '.list-group-item{cursor:pointer;}.list-group-item>.font{float:right;}span.indent{margin-left:10px;margin-right:10px}span.icon{margin-right:5px}'
